...
import submitter.credentials.Constants;
import utils.DateUtil;
import utils.ModifyUtil;
import utils.SolverUtil;
...
public class WebsiteActions {
    ...
    public static void submitToAboutCom(FirefoxDriver driver, Giveaway giveaway) throws InterruptedException {
        ...
        driver.findElement(By.id("entry_1103244773")).sendKeys(giveaway.getEndDate());
    ...
    public static void fixSubmitToBigSweeps(FirefoxDriver driver, Giveaway giveaway) throws ParseException, InterruptedException {
        ...
        driver.findElement(By.id("sweep_enddate")).sendKeys(DateUtil.changeDateToSlashes(giveaway.getEndDate()));
        driver.findElement(By.id("sweep_drawingdate")).sendKeys(DateUtil.changeDateToSlashes(giveaway.getEndDate()));
    ...
    public static void submitToGiveawayJunkie(FirefoxDriver driver, Giveaway giveaway) throws ParseException, InterruptedException {
        ...
        new Select(driver.findElement(By.id("month"))).selectByValue(ModifyUtil.addZero(DateUtil.stringDateMonth(giveaway.getEndDate())));
        new Select(driver.findElement(By.id("day"))).selectByValue(ModifyUtil.addZero(DateUtil.stringDateDay(giveaway.getEndDate())));
        new Select(driver.findElement(By.id("year"))).selectByValue(DateUtil.stringDateYear(giveaway.getEndDate()));
    ...
    public static void submitToHyperSweep(FirefoxDriver driver, Giveaway giveaway) throws ParseException {
        ...
        driver.findElement(By.name("CashValue")).sendKeys(giveaway.getPrizeValue());
        ...
        driver.findElement(By.name("EndDate")).sendKeys(DateUtil.changeDateToSlashes(giveaway.getEndDate()));
    ...
    public static void submitToInfiniteSweeps(FirefoxDriver driver, Giveaway giveaway) throws ParseException {
        ...
        toDateBox.clear();
        toDateBox.sendKeys(DateUtil.changeDateToDashes(giveaway.getEndDate()));
    ...
    public static void submitToSweepstakesSearch(FirefoxDriver driver, Giveaway giveaway) throws ParseException, Exception, InterruptedException, IOException {
        ...
        driver.findElement(By.name("prizeval")).sendKeys(giveaway.getPrizeValue());


        driver.findElement(By.name("enddate")).clear();
        driver.findElement(By.name("enddate")).sendKeys(DateUtil.changeDateToDashes(giveaway.getEndDate()));
    ...
    public static void submitToAnyLuckyDay(FirefoxDriver driver, Giveaway giveaway) throws MalformedURLException, ParseException {
        ...
        new Select(driver.findElement(By.id("field7"))).selectByValue(DateUtil.stringDateMonth(giveaway.getEndDate()));
        new Select(driver.findElement(By.id("field8"))).selectByValue(DateUtil.stringDateDay(giveaway.getEndDate()));
        new Select(driver.findElement(By.id("field9"))).selectByValue(DateUtil.stringDateYear(giveaway.getEndDate()));
    ...
    public static void submitToBlogGiveawayDirectory(FirefoxDriver driver, Giveaway giveaway) throws MalformedURLException, ParseException {
        ...
        driver.findElement(By.id("input_14_5")).sendKeys(DateUtil.changeDateToSlashes(giveaway.getEndDate()));
    ...
    public static void submitToContestCanada(FirefoxDriver driver, Giveaway giveaway) throws ParseException, InterruptedException {
        ...
        driver.findElement(By.id("submit_expiry_date")).sendKeys(DateUtil.changeDateToDashes(giveaway.getEndDate()));
    ...
    public static void submitToContestChest(FirefoxDriver driver, Giveaway giveaway) throws ParseException {
        ...
        try {
            driver.findElement(By.id("year")).sendKeys(DateUtil.stringDateYear(giveaway.getEndDate()));
            driver.findElement(By.id("month")).sendKeys(DateUtil.stringDateMonth(giveaway.getEndDate()));
            driver.findElement(By.id("day")).sendKeys(DateUtil.stringDateDay(giveaway.getEndDate()));
            ...
            driver.findElement(By.id("arv")).sendKeys(giveaway.getPrizeValue());
    ...
    public static void submitToContestCorner(FirefoxDriver driver, Giveaway giveaway) throws ParseException, Exception, InterruptedException, IOException {
        ...
        driver.findElement(By.id("input_1_3")).sendKeys(DateUtil.changeDateToSlashes(giveaway.getEndDate()));
    ...
    public static void submitToContestGirl(FirefoxDriver driver, Giveaway giveaway) throws ParseException, InterruptedException {
        ...
        driver.findElement(By.name("expiry")).sendKeys(DateUtil.changeDateToSlashes(giveaway.getEndDate()));
    ...
    public static void submitToDoublePrizes(FirefoxDriver driver, Giveaway giveaway) throws ParseException {
        ...
        new Select(driver.findElement(By.id("contest_end_date_2i"))).selectByValue(DateUtil.stringDateMonth(giveaway.getEndDate()));
        new Select(driver.findElement(By.id("contest_end_date_3i"))).selectByValue(DateUtil.stringDateDay(giveaway.getEndDate()));
        new Select(driver.findElement(By.id("contest_end_date_1i"))).selectByValue(DateUtil.stringDateYear(giveaway.getEndDate()));
    ...
    public static void submitToEmperola(FirefoxDriver driver, Giveaway giveaway) throws ParseException, MalformedURLException {
        ...
        driver.findElement(By.name("date")).sendKeys(DateUtil.changeDateToDashes(giveaway.getEndDate()));
    ...
    public static void submitToGiveawayFrenzy(FirefoxDriver driver, Giveaway giveaway) throws ParseException {
        ...
        driver.findElement(By.id("ninja_forms_field_8")).sendKeys(DateUtil.changeDateToSlashes(giveaway.getEndDate()));
    ...
    public static void fixSubmitToGieawayHunt(FirefoxDriver driver, Giveaway giveaway) throws MalformedURLException, ParseException, InterruptedException {
        ...
        driver.findElement(By.name("Field14-1")).sendKeys(ModifyUtil.addZero(DateUtil.stringDateMonth(giveaway.getEndDate())));
        driver.findElement(By.name("Field14-1")).sendKeys(ModifyUtil.addZero(DateUtil.stringDateDay(giveaway.getEndDate())));
        driver.findElement(By.name("Field14-1")).sendKeys(DateUtil.stringDateYear(giveaway.getEndDate()));
    ...
    public static void submitToGiveawayMonkey(FirefoxDriver driver, Giveaway giveaway) throws IOException {
        ...
        driver.findElement(By.id("g_date")).sendKeys(giveaway.getEndDate());
    ...
    public static void paidSubmitToGiveawayPromote(FirefoxDriver driver, Giveaway giveaway) throws ParseException, InterruptedException {
        ...
        driver.findElement(By.id("input_124_17")).sendKeys(DateUtil.changeDateToSlashes(giveaway.getEndDate()));
        new Select(driver.findElement(By.id("input_124_22"))).selectByValue(DateUtil.getMonthName(giveaway.getEndDate()));
    ...
    public static void submitToILoveGiveaways(FirefoxDriver driver, Giveaway giveaway) throws InterruptedException, MalformedURLException, ParseException {
        ...
        driver.findElement(By.id("gendson")).sendKeys(DateUtil.changeDateToSlashes(giveaway.getEndDate()) + " 23:59");
    ...
    public static void submitToInternationalGiveaways(FirefoxDriver driver, Giveaway giveaway) throws ParseException {
        ...
        driver.findElement(By.id("id123-control9328251")).sendKeys(DateUtil.changeDateToSlashes(giveaway.getEndDate()));
    ...
    public static void submitToJuliesFreebies(FirefoxDriver driver, Giveaway giveaway) throws ParseException, MalformedURLException, InterruptedException {
        ...
        driver.findElement(By.id("input_1_17")).sendKeys(DateUtil.changeDateToSlashes(giveaway.getEndDate()));
    ...
    public static void submitToJustSweep(FirefoxDriver driver, Giveaway giveaway) throws ParseException, MalformedURLException, InterruptedException {
        ...
        driver.findElement(By.id("input_3_15_1")).sendKeys(ModifyUtil.addZero(DateUtil.stringDateMonth(giveaway.getEndDate())));
        driver.findElement(By.id("input_3_15_2")).sendKeys(ModifyUtil.addZero(DateUtil.stringDateDay(giveaway.getEndDate())));
        driver.findElement(By.id("input_3_15_3")).sendKeys(DateUtil.stringDateYear(giveaway.getEndDate()));
    ...
    public static void submitToOnlineSweepstakes(FirefoxDriver driver, Giveaway giveaway) throws ParseException {
        ...
        driver.findElement(By.name("ExpirationDate")).sendKeys(DateUtil.changeDateToSlashes(giveaway.getEndDate()));
...
//        driver.get("http://www.primefaces.org/showcase/ui/misc/captcha.xhtml");
    ...
    public static void submitToSweepstakesMax(FirefoxDriver driver, Giveaway giveaway) throws ParseException {
        ...
        driver.findElement(By.name("title")).sendKeys(giveaway.getSweepstakesName());
        driver.findElement(By.name("url")).sendKeys(giveaway.getUrl());
        driver.findElement(By.id("dijit_form_DateTextBox_0")).sendKeys(DateUtil.changeDateToDashes(giveaway.getEndDate()));
        new Select(driver.findElement(By.name("catId"))).selectByValue("12");
        driver.findElement(By.name("grandPrizeVal")).sendKeys(giveaway.getPrizeValue());
    ...
    public static void submitToWinASweepstakes(FirefoxDriver driver, Giveaway giveaway) throws ParseException, IOException, Exception, InterruptedException {
        ...
        driver.findElement(By.name("prize_value")).sendKeys(giveaway.getPrizeValue());
        ...
        driver.findElement(By.name("end_date")).sendKeys(DateUtil.changeDateToSlashes(giveaway.getEndDate()));
